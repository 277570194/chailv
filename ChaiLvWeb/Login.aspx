            ...
            <div class="easyui-panel" fit="true" style="text-align: center;">
                <table border="0" width="100%" style="line-height: 25px">
                    <tr>
                        ...
                        <td align="center">
                            <input name="txtDepartment" id="txtDepartment" class="easyui-combobox" editable="false" required="true" valuefield="id" textfield="name" missingmessage="请选择机关!" />
                        </td>
                    </tr>
                    <tr>
                        <td align="right">职&nbsp;&nbsp;别:</td>
                        <td align="center">
                            <input id="txtZhiBie" name="txtZhiBie" class="easyui-combobox" required="true" editable="false" valuefield="id" disabled="disabled" textfield="name" missingmessage="请选择职别!" />
                        </td>
                    </tr>
                    <tr>
                        <td align="right">姓&nbsp;&nbsp;名:</td>
                        <td align="center">
                            <input type="text" name="username" class="easyui-validatebox" style="border-radius: 2px" required="true" missingmessage="请输入姓名!" /></td>
                    </tr>
                    <tr>
                        <td align="right">密&nbsp;&nbsp;码:</td>
                        <td align="center">
                            <input type="password" name="password" class="easyui-validatebox" style="border-radius: 2px" required="true" missingmessage="请输入密码!" /></td>
                    </tr>
                    <tr align="right">
                        <td colspan="2">
